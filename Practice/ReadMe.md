...
## 17. Spring приложение
Написать любое Spring приложение (рассмотрена отправка электронной почты с
...
Необходимо перевести на использование EntityManager для Dao слоя + реализовать пару сервисов с использованием CrudRepository.

## 20. Spring MVC
20.1. Написать WEB-приложение c сервлетом|сервлетным фильтром,
